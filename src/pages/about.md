...
I designed and developed this site, using [Astro](https://astro.build) to assemble it and [Cloudflare Workers](https://workers.cloudflare.com) to host it. The code is available on [GitHub](https://github.com/samhermes/samhermes.github.io).